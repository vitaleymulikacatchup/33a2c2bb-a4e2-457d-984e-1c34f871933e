...
export const metadata: Metadata = {
  title: "Personal Photo Gallery - Professional Photography Portfolio",
  description: "Explore our stunning photo gallery featuring wedding, portrait, landscape, and event photography. Professional photographer capturing life's precious moments with artistic vision.",
  keywords: ["photo gallery", "professional photographer", "wedding photography", "portrait photography", "landscape photography", "event photography", "photography portfolio"],
  metadataBase: new URL("https://photostudio.com"),
  alternates: {
    canonical: "https://photostudio.com"
  },
  openGraph: {
    title: "Personal Photo Gallery - Professional Photography Portfolio",
    description: "Explore our stunning photo gallery featuring wedding, portrait, landscape, and event photography.",
    url: "https://photostudio.com",
    siteName: "PhotoStudio",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/tmp/uploaded-1763031979111-yxxqhoxv.jpg",
        alt: "Professional photography portfolio showcase"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Personal Photo Gallery - Professional Photography Portfolio",
    description: "Explore our stunning photo gallery featuring wedding, portrait, landscape, and event photography.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/tmp/uploaded-1763031979111-yxxqhoxv.jpg"]
  },
  robots: {
    index: true,
    follow: true
